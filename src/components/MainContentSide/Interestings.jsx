  ...
  return (
    <>
      <Row className="border rounded-2 bg-white  mt-3">
        <Col>
          <p className="fw-semibold m-0">Potrebbe interessarti</p>
        ...
        <div className="mt-3">
          <Row>
            ...
            <Col xs={9}>
              <p className="fw-semibold m-0 p-0 profile-name">Flos</p>
              <p className=" m-0 p-0">Illuminotecnica </p>
              ...
              <Button className="me-3 bg-transparent text-secondary border border-secondary-subtle  rounded-pill PlusLg fw-bold">
                <PlusLg />
                Segui
              </Button>
            </Col>
